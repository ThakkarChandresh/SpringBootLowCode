				...
				<div class="content-wrapper">
					...
					<div class="d-flex justify-content-sm-between align-items-center">
						<div class="d-flex justify-content-start align-items-center">
							<i style="font-size: 35px" class="mdi mdi-file mr-3"></i>
							<div>
								<h4>Forms</h4>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-2">
										<button type="button" id="formAddButton"
								...
								<table class="table table-striped border">
									<thead>
										<tr class="text-center">
											<th rowspan="2" class="pb-3" scope="col">#</th>
											<th rowspan="2" class="pb-3" scope="col">Field Name</th>
											<th rowspan="2" class="pb-3" scope="col">Field Type</th>
